...
bot.on('guildMemberAdd', (guildMember) =>
{
    ...
    const coreChannel = guildMember.guild.channels.find('name', 'company_leadership');

    const memberLogChannel = guildMember.guild.channels.find('name', 'member_log');

    // Post a message in general/company_leadership/member_log notifying users of new member.
