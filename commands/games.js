    ...
    if (!error && response.statusCode == 200) {
      ...
      if(games.length != 0) {
        games.forEach(game => {
          ...
          msg.channel.sendMessage(msg.channel, '**Game Creator:** ' + game.creator_gamertag +
        ...
        msg.channel.sendMessage(msg.channel, "There are currently no games scheduled, but since you asked, that means you want to play. Go make one!! ***It's a perfect day for some mayhem!***");
      }
    }
    else {
